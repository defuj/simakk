        ...
        <div class="col-xl-4">
            ...
            <a class="card card-custom bg-primary bg-hover-state-primary card-stretch gutter-b" @click="CreateNew()">
                ...
                <div class="card-body">
                    ...
                    <div class="text-inverse-primary font-weight-bolder font-size-h5 mb-2 mt-5">Buat Baru</div>
                    <div class="font-weight-bold text-inverse-primary font-size-sm">Buat Kuesioner Manual</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Stats Widget 14-->
        ...
        <div class="col-xl-4">
            ...
            <a href="#" class="card card-custom bg-info bg-hover-state-info card-stretch card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="text-inverse-info font-weight-bolder font-size-h5 mb-2 mt-5">Template Kuesioner</div>
                    <div class="font-weight-bold text-inverse-info font-size-sm">Atur template kuesioner tersedia</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Stats Widget 17-->
        ...
        <div class="col-xl-4">
            ...
            <a href="#" class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body bg-menu bgi-no-repeat">
                    ...
                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Buat dari template</div>
                    <div class="font-weight-bold text-inverse-white font-size-sm">Ambil data dari template kuesioner</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Stats Widget 16-->
